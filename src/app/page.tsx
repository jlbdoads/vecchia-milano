    ...
    <div className="min-h-screen bg-white">
      ...
      <header className="fixed top-0 left-0 right-0 bg-white/95 backdrop-blur-sm z-50 border-b border-gray-100">
        <div className="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <Link
            href={`https://wa.me/${phone}?text=Olá! Gostaria de conhecer as koleksiões da Vecchia Milano.`}
            target="_blank"
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href={`https://wa.me/${phone}?text=Olá! Gostaria de conhecer as koleksiões da Vecchia Milano.`}
              target="_blank"
              className="bg-dark text-white px-8 py-4 rounded-full font-medium hover:bg-gray-800 transition-colors text-lg"
            >
              Ver Koleção →
            </Link>
            <Link
              href={`https://wa.me/${phone}?text=Olá! Gostaria de agendar um atendimento personalizado na Vecchia Milano.`}
              target="_blank"
              className="border-2 border-dark text-dark px-8 py-4 rounded-full font-medium hover:bg-dark hover:text-white transition-colors text-lg"
            >
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-gray-100 rounded-2xl p-8 text-center">
              ...
              <Link
                href={`https://wa.me/${phone}?text=Olá! Gostaria de conhecer a Coleção Social da Vecchia Milano.`}
                target="_blank"
            ...
            <div className="bg-gray-100 rounded-2xl p-8 text-center">
              ...
              <Link
                href={`https://wa.me/${phone}?text=Olá! Gostaria de conhecer a Coleção Casual da Vecchia Milano.`}
                target="_blank"
                className="inline-block bg-dark text-white px-6 py-3 rounded-full font-medium hover:bg-gray-800 transition-colors"
              >
                Solicitar Catálogo
